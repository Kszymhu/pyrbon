...
def test_cli_accepts_short_arguments() -> None:
    ...
    arguments = ['graphene', '-a', str(dummy_a), '-b', str(dummy_b)]
...
def test_cli_accepts_long_arguments() -> None:
    ...
    arguments = ['graphene', '--dummy_a', str(dummy_a), '--dummy_b', str(dummy_b)]
...
def test_cli_accepts_reverse_order_short_arguments() -> None:
    ...
    arguments = ['graphene', '-b', str(dummy_b), '-a', str(dummy_a)]
...
def test_cli_accepts_reverse_order_long_arguments() -> None:
    ...
    arguments = ['graphene', '--dummy_b', str(dummy_b), '--dummy_a', str(dummy_a)]
